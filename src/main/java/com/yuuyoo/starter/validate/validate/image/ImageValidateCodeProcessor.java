...
public class ImageValidateCodeProcessor extends AbstractValidateProcessor<ImageCode> {
	...
	@Override
	protected ImageCode generate(ServletWebRequest request) throws IOException {
		...
		String resStr = validateCodeGenerator.image(
		...
		ImageCode imageCode = JSON.parseObject(resStr,ImageCode.class);
		return imageCode;
	}
